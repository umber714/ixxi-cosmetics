...
export const products: Product[] = [
  ...
  {
    id: '12',
    name: 'Proteina Capilar IXXI',
    description: 'Tratamiento de proteina capilar que repara y fortalece el cabello danado. Restaura la estructura del cabello desde el interior.',
    price: 74.99,
    ...
    reviews: 198,
    isBestSeller: true,
    ingredients: ['Proteina Hidrolizada', 'Keratina', 'Aminoacidos', 'Vitamina E'],
    usage: 'Aplicar sobre el cabello lavado y humedo. Dejar actuar 15-20 minutos y enjuagar con agua tibia.',
    benefits: ['Repara cabello danado', 'Fortalece la fibra capilar', 'Reduce el quiebre'],
  },
  {
    id: '13',
